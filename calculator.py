...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.le_entry.setMinimumSize(QSize(300, 0))
        ...
        self.loyout_buttons = QGridLayout()
        self.loyout_buttons.setObjectName(u"loyout_buttons")
        ...
        self.loyout_buttons.addWidget(self.btn_4, 2, 0, 1, 1)
        ...
        self.loyout_buttons.addWidget(self.btn_neg, 4, 0, 1, 1)
        ...
        self.loyout_buttons.addWidget(self.btn_3, 3, 2, 1, 1)
        ...
        self.loyout_buttons.addWidget(self.btn_8, 1, 1, 1, 1)
        ...
        self.loyout_buttons.addWidget(self.btn_2, 3, 1, 1, 1)
        ...
        self.loyout_buttons.addWidget(self.btn_0, 4, 1, 1, 1)
        ...
        self.loyout_buttons.addWidget(self.btn_add, 3, 3, 1, 1)
        ...
        self.loyout_buttons.addWidget(self.btn_5, 2, 1, 1, 1)
        ...
        self.loyout_buttons.addWidget(self.btn_6, 2, 2, 1, 1)
        ...
        self.loyout_buttons.addWidget(self.btn_ce, 0, 1, 1, 1)

        self.btn_ = QPushButton(self.centralwidget)
        self.btn_.setObjectName(u"btn_")
        sizePolicy2.setHeightForWidth(self.btn_.sizePolicy().hasHeightForWidth())
        self.btn_.setSizePolicy(sizePolicy2)
        self.btn_.setCursor(QCursor(Qt.PointingHandCursor))

        self.loyout_buttons.addWidget(self.btn_, 2, 3, 1, 1)
        ...
        self.loyout_buttons.addWidget(self.btn_9, 1, 2, 1, 1)
        ...
        self.loyout_buttons.addWidget(self.btn_div, 0, 3, 1, 1)
        ...
        self.loyout_buttons.addWidget(self.btn_mul, 1, 3, 1, 1)
        ...
        self.loyout_buttons.addWidget(self.btn_calc, 4, 3, 1, 1)
        ...
        self.loyout_buttons.addWidget(self.btn_backspase, 0, 2, 1, 1)
        ...
        self.loyout_buttons.addWidget(self.btn_point, 4, 2, 1, 1)
        ...
        self.loyout_buttons.addWidget(self.btn_1, 3, 0, 1, 1)
        ...
        self.loyout_buttons.addWidget(self.btn_clear, 0, 0, 1, 1)
        ...
        self.loyout_buttons.addWidget(self.btn_7, 1, 0, 1, 1)

        self.verticalLayout.addLayout(self.loyout_buttons)
    ...
    def retranslateUi(self, MainWindow):
        ...
        # if QT_CONFIG(shortcut)
        self.btn_.setShortcut(QCoreApplication.translate("MainWindow", u"-", None))
        # endif // QT_CONFIG(shortcut)
